...
Para prosseguir com sua {{ $inscricao_ou_matricula }}, clique <a href="{{ config('app.url') }}/{{ request()->segment(1) }}/edit/{{ $inscricao->id }}#card_arquivos">aqui</a> e envie os documentos necessários.<br />
