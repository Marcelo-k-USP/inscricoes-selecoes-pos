    ...
    public function run()
    {
        ...
        $selecoes = [
            [
                ...
                'datahora_inicio' => Carbon::createFromFormat('d/m/Y H:i', '01/11/2024 08:00')->format('Y-m-d'),
                'datahora_fim' => Carbon::createFromFormat('d/m/Y H:i', '01/02/2025 23:59')->format('Y-m-d'),
                'boleto_valor' => 50.0,
                'boleto_texto' => 'Boleto de Inscrição do Processo Seletivo da Pós-Graduação',
                'boleto_data_vencimento' => Carbon::createFromFormat('d/m/Y', '02/02/2025')->format('Y-m-d'),
                'template' => '{
                    "nome": {
                        "label": "Nome",
                        "type": "text",
